...
const CryptoTracker: React.FC = () => {
  const [cryptoData, setCryptoData] = useState<CryptoData[]>([
    { symbol: 'ETH/USD', price: 0, change: 0, icon: '/images/icons/eth.svg' },
    { symbol: 'USDT/USD', price: 0, change: 0, icon: '/images/icons/usdt.svg' },
    { symbol: 'CNGN/USD', price: 0, change: 0, icon: '/images/icons/cngn.svg' },
  ]);
